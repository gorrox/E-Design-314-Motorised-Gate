...
src/r_cg_intc.o: ../src/r_cg_intc.c
	...
	@echo	rl78-elf-gcc -MM -MP -MF "src/r_cg_intc.d" -MT"src/r_cg_intc.o" -MT"src/r_cg_intc.d" -x c   -nostdinc -I"C:\PROGRA~2\KPIT\GNURL7~1.02-\rl78-elf/rl78-elf/optlibinc" -Wstack-usage=64 -mrl78 -g2 -g "$<"
...
src/r_cg_intc_user.o: ../src/r_cg_intc_user.c
	...
	@echo	rl78-elf-gcc -MM -MP -MF "src/r_cg_intc_user.d" -MT"src/r_cg_intc_user.o" -MT"src/r_cg_intc_user.d" -x c   -nostdinc -I"C:\PROGRA~2\KPIT\GNURL7~1.02-\rl78-elf/rl78-elf/optlibinc" -Wstack-usage=64 -mrl78 -g2 -g "$<"
	@rl78-elf-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/r_cg_intc_user.sub" -o "$(@:%.d=%.o)" "$<"
	@echo rl78-elf-gcc -c -x c  -Wa,-adlhn="$(basename $(notdir $<)).lst" -nostdinc -I"C:\PROGRA~2\KPIT\GNURL7~1.02-\rl78-elf/rl78-elf/optlibinc" -Wstack-usage=64 -mrl78 -g2 -g -o "$(@:%.d=%.o)" "$<"
	@echo 'Finished scanning and building: $<'
	@echo.

src/r_cg_pclbuz.o: ../src/r_cg_pclbuz.c
	@echo 'Scanning and building file: $<'
	@echo 'Invoking: Scanner and Compiler'
	@rl78-elf-gcc -MM -MP -MF "src/r_cg_pclbuz.d" -MT"src/r_cg_pclbuz.o" -MT"src/r_cg_pclbuz.d" @"src/r_cg_pclbuz.depsub" "$<"
	@echo	rl78-elf-gcc -MM -MP -MF "src/r_cg_pclbuz.d" -MT"src/r_cg_pclbuz.o" -MT"src/r_cg_pclbuz.d" -x c   -nostdinc -I"C:\PROGRA~2\KPIT\GNURL7~1.02-\rl78-elf/rl78-elf/optlibinc" -Wstack-usage=64 -mrl78 -g2 -g "$<"
	@rl78-elf-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/r_cg_pclbuz.sub" -o "$(@:%.d=%.o)" "$<"
	@echo rl78-elf-gcc -c -x c  -Wa,-adlhn="$(basename $(notdir $<)).lst" -nostdinc -I"C:\PROGRA~2\KPIT\GNURL7~1.02-\rl78-elf/rl78-elf/optlibinc" -Wstack-usage=64 -mrl78 -g2 -g -o "$(@:%.d=%.o)" "$<"
	@echo 'Finished scanning and building: $<'
	@echo.

src/r_cg_pclbuz_user.o: ../src/r_cg_pclbuz_user.c
	@echo 'Scanning and building file: $<'
	@echo 'Invoking: Scanner and Compiler'
	@rl78-elf-gcc -MM -MP -MF "src/r_cg_pclbuz_user.d" -MT"src/r_cg_pclbuz_user.o" -MT"src/r_cg_pclbuz_user.d" @"src/r_cg_pclbuz_user.depsub" "$<"
	@echo	rl78-elf-gcc -MM -MP -MF "src/r_cg_pclbuz_user.d" -MT"src/r_cg_pclbuz_user.o" -MT"src/r_cg_pclbuz_user.d" -x c   -nostdinc -I"C:\PROGRA~2\KPIT\GNURL7~1.02-\rl78-elf/rl78-elf/optlibinc" -Wstack-usage=64 -mrl78 -g2 -g "$<"
	@rl78-elf-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/r_cg_pclbuz_user.sub" -o "$(@:%.d=%.o)" "$<"
	@echo rl78-elf-gcc -c -x c  -Wa,-adlhn="$(basename $(notdir $<)).lst" -nostdinc -I"C:\PROGRA~2\KPIT\GNURL7~1.02-\rl78-elf/rl78-elf/optlibinc" -Wstack-usage=64 -mrl78 -g2 -g -o "$(@:%.d=%.o)" "$<"
	@echo 'Finished scanning and building: $<'
	@echo.
...
src/r_cg_rtc.o: ../src/r_cg_rtc.c
	@echo 'Scanning and building file: $<'
	@echo 'Invoking: Scanner and Compiler'
	@rl78-elf-gcc -MM -MP -MF "src/r_cg_rtc.d" -MT"src/r_cg_rtc.o" -MT"src/r_cg_rtc.d" @"src/r_cg_rtc.depsub" "$<"
	@echo	rl78-elf-gcc -MM -MP -MF "src/r_cg_rtc.d" -MT"src/r_cg_rtc.o" -MT"src/r_cg_rtc.d" -x c   -nostdinc -I"C:\PROGRA~2\KPIT\GNURL7~1.02-\rl78-elf/rl78-elf/optlibinc" -Wstack-usage=64 -mrl78 -g2 -g "$<"
	@rl78-elf-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/r_cg_rtc.sub" -o "$(@:%.d=%.o)" "$<"
	@echo rl78-elf-gcc -c -x c  -Wa,-adlhn="$(basename $(notdir $<)).lst" -nostdinc -I"C:\PROGRA~2\KPIT\GNURL7~1.02-\rl78-elf/rl78-elf/optlibinc" -Wstack-usage=64 -mrl78 -g2 -g -o "$(@:%.d=%.o)" "$<"
	@echo 'Finished scanning and building: $<'
	@echo.

src/r_cg_rtc_user.o: ../src/r_cg_rtc_user.c
	@echo 'Scanning and building file: $<'
	@echo 'Invoking: Scanner and Compiler'
	@rl78-elf-gcc -MM -MP -MF "src/r_cg_rtc_user.d" -MT"src/r_cg_rtc_user.o" -MT"src/r_cg_rtc_user.d" @"src/r_cg_rtc_user.depsub" "$<"
	@echo	rl78-elf-gcc -MM -MP -MF "src/r_cg_rtc_user.d" -MT"src/r_cg_rtc_user.o" -MT"src/r_cg_rtc_user.d" -x c   -nostdinc -I"C:\PROGRA~2\KPIT\GNURL7~1.02-\rl78-elf/rl78-elf/optlibinc" -Wstack-usage=64 -mrl78 -g2 -g "$<"
...
src/r_cg_serial.o: ../src/r_cg_serial.c
	...
	@echo	rl78-elf-gcc -MM -MP -MF "src/r_cg_serial.d" -MT"src/r_cg_serial.o" -MT"src/r_cg_serial.d" -x c   -nostdinc -I"C:\PROGRA~2\KPIT\GNURL7~1.02-\rl78-elf/rl78-elf/optlibinc" -Wstack-usage=64 -mrl78 -g2 -g "$<"
...
src/r_cg_serial_user.o: ../src/r_cg_serial_user.c
	...
	@echo	rl78-elf-gcc -MM -MP -MF "src/r_cg_serial_user.d" -MT"src/r_cg_serial_user.o" -MT"src/r_cg_serial_user.d" -x c   -nostdinc -I"C:\PROGRA~2\KPIT\GNURL7~1.02-\rl78-elf/rl78-elf/optlibinc" -Wstack-usage=64 -mrl78 -g2 -g "$<"
