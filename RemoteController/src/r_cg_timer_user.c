...
void r_tau0_channel0_interrupt(void)
{
	...
	//PWM Master
	if (tx && modulate) P1_bit.no0 = 1; //alternate
...
void r_tau0_channel1_interrupt(void)
{
    /* Start user code. Do not edit comment generated here */
	//PWM Slave
	if (tx && modulate) P1_bit.no0 = 0; //alternate
    /* End user code. Do not edit comment generated here */
}
...
void r_tau0_channel3_interrupt(void)
{
	...
	//Half-bit Manchester RC5
	if (!modulate) P1_bit.no0 = 0; //Steady zero when not modulating
	if (tx) transmit();
    /* End user code. Do not edit comment generated here */
}
